  ...
  return (
    <div className='  flex flex-row justify-between items-center h-20 px-7'>
        <div onClick={() => {navigate("/dashboard")}}>
            <span className=' text-[#fb7800] font-bold font-poppins cursor-pointer'>B4MUSIC</span>
        </div>
        <div className=' flex flex-row items-center'>
            <input type="text" placeholder='Search' className=' border-2 border-[#fb7800] bg-transparent placeholder:font-poppins placeholder:text-sm outline-none text-white font-poppins text-sm w-80 md:w-[30rem] h-10 rounded-tl-lg rounded-bl-lg pl-3'/>
